...
<header id="myCarousel" class="carousel slide">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" id="opac"><b>Flights</b></a></li>
    <li role="presentation" class="active"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" id="opac"><b>Hotels</b></a></li>
 ...
 <div class="container" id="padd36">
  <h1>Procession Hotels</h1>
   <div class="col-lg-12">
     <div class="col-lg-4">
            <a href="inside-hotel.php"><img src="images/hotel001.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="inside-hotel.php"><h4>Flat 50% offer</h4></a>
                <a href="inside-hotel.php"><p>valid till December 7, 2016</p></a>
            </div>
    </div>
    <div class="col-lg-4">
            <a href="inside-hotel.php"><img src="images/hotel002.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="inside-hotel.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="inside-hotel.php"><p>valid till December 7, 2016</p></a>
            </div>
    </div>
    <div class="col-lg-4">
            <a href="inside-hotel.php"><img src="images/hotel003.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="inside-hotel.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="inside-hotel.php"><p>valid till December 7, 2016</p></a>
            </div>
   ...
   <div class="col-lg-12" id="top6">
     <div class="col-lg-4">
            <a href="inside-hotel.php"><img src="images/hotel004.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="inside-hotel.php"><h4>Flat 50% offer</h4></a>
                <a href="inside-hotel.php"><p>valid till December 7, 2016</p></a>
            </div>
    ...
    <div class="col-lg-4">
            <a href="inside-hotel.php"><img src="images/hotel005.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="inside-hotel.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="inside-hotel.php"><p>valid till December 7, 2016</p></a>
            </div>
    ...
    <div class="col-lg-4">
            <a href="inside-hotel.php"><img src="images/hotel006.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="inside-hotel.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="inside-hotel.php"><p>valid till December 7, 2016</p></a>
            </div>
 ...
 <div class="col-lg-12" id="pad23">
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 400px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
            <div data-p="112.50">
                <img data-u="image" src="images/hotel001.jpg" />
                <div data-u="thumb">
                    <img src="images/hotelsm1.jpg" />
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="images/hotel002.jpg" />
                <div data-u="thumb">
                    <img src="images/hotelsm2.jpg" />
                    <div class="title_back"></div>
                    <div class="title">
                        Hotel Interior
                    </div>
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="images/hotel003.jpg" />
                <div data-u="thumb">
                    <img src="images/hotelsm3.jpg" />
                    <div class="title_back"></div>
                    <div class="title">
                        Hotel Interior 1
                    </div>
