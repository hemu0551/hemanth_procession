...
<header id="myCarousel" class="carousel slide">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab" id="opac"><b>Holidays Activity</b></a></li>
  </ul>
...
<div class="container" id="padd36">
    <div class="row ">
        ...
        <div class="col-lg-4">
            <a href="holiday-activity.php"><img src="images/activity001.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="holiday-activity.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="holiday-activity.php"><p>valid till December 7, 2016</p></a>
            </div>
        </div>
                <div class="col-lg-4">
            <a href="holiday-activity.php"><img src="images/activity002.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="holiday-activity.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="holiday-activity.php"><p>valid till December 7, 2016</p></a>
            </div>
                ...
                <div class="col-lg-4">
            <a href="holiday-activity.php"><img src="images/activity003.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="holiday-activity.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="holiday-activity.php"><p>valid till December 7, 2016</p></a>
            </div>
    ...
    <div class="row" id="top6">
                <h1>Popular Domestic Flights</h1>
                  <div class="col-lg-4">
            <a href="holiday-activity.php"><img src="images/activity004.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="holiday-activity.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="holiday-activity.php"><p>valid till December 7, 2016</p></a>
            </div>
                ...
                <div class="col-lg-4">
            <a href="holiday-activity.php"><img src="images/activity005.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="holiday-activity.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="holiday-activity.php"><p>valid till December 7, 2016</p></a>
            </div>
            ...
            <div class="col-lg-4">
            <a href="holiday-activity.php"><img src="images/activity006.jpg" class="box1" id="pad1"></a>
            <div id="having">
                <a href="holiday-activity.php"><h4>Flat 20% offer on Fortune Hotels</h4></a>
                <a href="holiday-activity.php"><p>valid till December 7, 2016</p></a>
            </div>
...
<div class="col-lg-12" id="pad23">
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 400px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
            <div data-p="112.50">
                <img data-u="image" src="images/activity004.jpg" />
                <div data-u="thumb">
                    <img src="images/activitysm4.jpg" />
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="images/activity005.jpg" />
                <div data-u="thumb">
                    <img src="images/activitysm5.jpg" />
                    <div class="title_back"></div>
                    <div class="title">
                          activity 2
                    </div>
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="images/activity006.jpg" />
                <div data-u="thumb">
                    <img src="images/activitysm6.jpg" />
                    <div class="title_back"></div>
                    <div class="title">
                          activity 3
                    </div>
